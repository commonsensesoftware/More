namespace More.IO
{
    ...
    class BasicPropertiesAdapter<T> : IBasicProperties where T : FileSystemInfo
    {
        static readonly Lazy<IDictionary<string, Func<T, object>>> lazyAttributeReaders = new Lazy<IDictionary<string, Func<T, object>>>( CreateAttributeReaders );
        static readonly Lazy<IDictionary<string, Action<T, object>>> lazyAttributeWriters = new Lazy<IDictionary<string, Action<T, object>>>( CreateAttributeWriters );
        readonly T storageItem;
        ...
        static IDictionary<string, Func<T, object>> CreateAttributeReaders()
        {
        ...
        static IDictionary<string, Action<T, object>> CreateAttributeWriters()
        {
        ...
        IDictionary<string, Func<T, object>> AttributeReaders
        {
            get
            {
        ...
        IDictionary<string, Action<T, object>> AttributeWriters
        {
            get
            {
        ...
        public Task<IDictionary<string, object>> RetrievePropertiesAsync( IEnumerable<string> propertiesToRetrieve )
        {
            ...
            {
                if ( AttributeReaders.TryGetValue( property, out var reader ) )
                {
        ...
        public Task SavePropertiesAsync() => CompletedTask.Value;
        ...
        public Task SavePropertiesAsync( IEnumerable<KeyValuePair<string, object>> propertiesToSave )
        {
            ...
            {
                if ( AttributeWriters.TryGetValue( property.Key, out var writer ) )
                {
