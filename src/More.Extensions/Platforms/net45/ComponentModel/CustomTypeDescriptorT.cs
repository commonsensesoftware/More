namespace More.ComponentModel
{
    ...
    {
        readonly ObservableKeyedCollection<string, PropertyDescriptor> extensionProperties = new ObservableKeyedCollection<string, PropertyDescriptor>( p => p.Name );
        ...
        public CustomTypeDescriptor( ICustomTypeDescriptor parent ) : base( parent ) { }
        ...
        public CustomTypeDescriptor( ICustomTypeDescriptor parent, CustomTypeDescriptor<T> other ) : base( parent )
        {
        ...
        public override string GetClassName() => TypeDescriptor.GetClassName( typeof( T ) );
