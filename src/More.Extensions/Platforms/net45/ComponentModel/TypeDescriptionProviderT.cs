namespace More.ComponentModel
{
    ...
    {
        readonly TypeDescriptionProvider baseProvider = TypeDescriptor.GetProvider( typeof( T ) );
        readonly Func<ICustomTypeDescriptor, ICustomTypeDescriptor> factory;
        ...
        public override ICustomTypeDescriptor GetTypeDescriptor( Type objectType, object instance ) =>
            factory( baseProvider.GetTypeDescriptor( objectType, instance ) );
    }
}