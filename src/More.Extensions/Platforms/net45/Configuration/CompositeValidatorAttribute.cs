namespace More.Configuration
{
    ...
    {
        readonly Func<IEnumerable<ConfigurationValidatorBase>> factory;
        ...
        public CompositeValidatorAttribute( Type factoryType, string methodName )
        {
            ...
            var flags = IgnoreCase | Static | Instance | Public | FlattenHierarchy;
            ...
            if ( !method.IsStatic )
            {
                throw new ArgumentException( SR.ExpectedStaticMethod.FormatDefault( methodName, factoryType.FullName ), nameof( methodName ) );
            }
        ...
        public override ConfigurationValidatorBase ValidatorInstance => new CompositeValidator( factory() );
    }
}