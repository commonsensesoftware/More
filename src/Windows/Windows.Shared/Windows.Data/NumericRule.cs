namespace More.Windows.Data
{
    ...
    {
        private readonly Lazy<ObservableCollection<IRule<decimal?, bool>>> rules = new Lazy<ObservableCollection<IRule<decimal?, bool>>>( () => new ObservableCollection<IRule<decimal?, bool>>() );
