namespace More.Windows.Data
{
    ...
    /// ]]></code></example>
#if NETFX_CORE
    [ContentProperty( Name = "ConvertRules" )]
#else
    [ContentProperty( "ConvertRules" )]
#endif
    public class NumericDenominationConverter : IValueConverter
    {
        private readonly Lazy<ObservableCollection<DenominationConvertRule>> convertRules = new Lazy<ObservableCollection<DenominationConvertRule>>( () => new ObservableCollection<DenominationConvertRule>() );
        private readonly Lazy<ObservableCollection<DenominationConvertBackRule>> convertBackRules = new Lazy<ObservableCollection<DenominationConvertBackRule>>( () => new ObservableCollection<DenominationConvertBackRule>() );
        ...
        private static object CoerceValue( string value, decimal denomination, Type targetType, CultureInfo culture )
        {
