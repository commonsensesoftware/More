namespace More.Windows.Data
{
    ...
    public class EnumerableConverter : FormatConverter
    {
        ...
        public virtual string EmptyFormat
        {
            get;
            set;
        }
        ...
        public virtual string SingleItemFormat
        {
            get;
            set;
        }
        ...
        private string FormatItem( object item, CultureInfo culture )
        {
            if ( item == null )
                return null;
...
#endif
        {
            ...
            if ( !typeof( IEnumerable ).GetTypeInfo().IsAssignableFrom( sourceType.GetTypeInfo() ) )
                throw new ArgumentException( ExceptionMessage.InvalidTypeException.FormatDefault( typeof( IEnumerable ) ), "value" );
#if NETFX_CORE
