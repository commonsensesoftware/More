namespace System.Globalization
{
    ...
    {
        private static readonly int[] DaysToMonth365 = new[] { 0, 0x1f, 0x3b, 90, 120, 0x97, 0xb5, 0xd4, 0xf3, 0x111, 0x130, 0x14e, 0x16d };
        private static readonly int[] DaysToMonth366 = new[] { 0, 0x1f, 60, 0x5b, 0x79, 0x98, 0xb6, 0xd5, 0xf4, 0x112, 0x131, 0x14f, 0x16e };
        private int twoDigitYearMax = -1;
        ...
        private static long GetAbsoluteDate( int year, int month, int day )
        {
        ...
        public override DateTime AddMonths( DateTime time, int months )
        {
            if ( ( months < -120000 ) || ( months > 0x1d4c0 ) )
                throw new ArgumentOutOfRangeException( "months", ExceptionMessage.ArgumentOutOfRangeRange.FormatDefault( -120000, 0x1d4c0 ) );
        ...
        {
            if ( ( era != 0 ) && ( era != 1 ) )
                throw new ArgumentOutOfRangeException( "era", ExceptionMessage.ArgumentOutOfRangeInvalidEraValue );
            ...
            if ( ( month < 1 ) || ( month > 12 ) )
                throw new ArgumentOutOfRangeException( "month", ExceptionMessage.ArgumentOutOfRangeMonth );
        ...
        {
            if ( ( month < 1 ) || ( month > 12 ) )
                throw new ArgumentOutOfRangeException( "month", ExceptionMessage.ArgumentOutOfRangeRange.FormatDefault( 1, 12 ) );
        ...
        {
            if ( year < 0 )
                throw new ArgumentOutOfRangeException( "year", ExceptionMessage.ArgumentOutOfRangeNeedNonNegNum );
