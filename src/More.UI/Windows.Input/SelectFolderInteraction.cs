namespace More.Windows.Input
{
    ...
    {
        readonly ObservableCollection<string> fileTypeFilter = new ObservableCollection<string>();

        /// <summary>
        /// Initializes a new instance of the <see cref="SelectFolderInteraction"/> class.
        /// </summary>
        public SelectFolderInteraction() : this( string.Empty ) { }
        ...
        public SelectFolderInteraction( string title, params string[] fileTypeFilter ) : base( title )
        {
