namespace More.Windows.Input
{
    ...
    {
        readonly ObservableCollection<IFile> files = new ObservableCollection<IFile>();
        readonly ObservableCollection<FileType> fileTypeFilter = new ObservableCollection<FileType>();
        bool multiselect;

        /// <summary>
        /// Initializes a new instance of the <see cref="OpenFileInteraction"/> class.
        /// </summary>
        public OpenFileInteraction() : this( string.Empty, false ) { }
        ...
        /// <param name="fileTypeFilter">An array of <see cref="FileType">file type</see> that specify the file types to display.</param>
        public OpenFileInteraction( string title, bool multiselect, params FileType[] fileTypeFilter ) : base( title )
        {
