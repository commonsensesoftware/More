namespace More.ComponentModel
{
    ...
    public class ExpandableItem<T> : ObservableObject, IExpandableItem<T>, IEquatable<IExpandableItem<T>>, IEquatable<T>
    {
        ...
        public ExpandableItem( T value ) : this( false, value, EqualityComparer<T>.Default ) { }
        ...
        public ExpandableItem( T value, IEqualityComparer<T> comparer ) : this( false, value, comparer ) { }
        ...
        /// <param name="value">The item value.</param>
        public ExpandableItem( bool expanded, T value ) : this( expanded, value, EqualityComparer<T>.Default ) { }
        ...
        public override bool Equals( object obj ) => Equals( obj as IExpandableItem<T> );
