namespace More.ComponentModel.DataAnnotations
{
    ...
    {
        readonly Lazy<IValidationResult> validationResult;

        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationException"/> class.
        /// </summary>
        public ValidationException() => validationResult = new Lazy<IValidationResult>( () => new ValidationResult( default( string ) ) );

        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationException"/> class.
        /// </summary>
        /// <param name="message">The error message.</param>
        public ValidationException( string message ) : base( message ) => validationResult = new Lazy<IValidationResult>( () => new ValidationResult( message ) );
        ...
        public ValidationException( IValidationResult validationResult, object value ) : base( validationResult == null ? null : validationResult.ErrorMessage )
        {
        ...
        /// <param name="value">The value that caused the exception.</param>
        public ValidationException( string errorMessage, object value ) : base( errorMessage )
        {
