namespace More.ComponentModel.DataAnnotations
{
    ...
    {
        readonly Lazy<Func<TObject, TValue>> getter;
        readonly Lazy<ValueTypeInfo<TValue>> valueTypeInfo = new Lazy<ValueTypeInfo<TValue>>( () => new ValueTypeInfo<TValue>() );
        readonly Lazy<List<IRule<Property<TValue>, IValidationResult>>> rules =
        ...
        bool IsForValueType => valueTypeInfo.Value.IsValueType;
