namespace More.VisualStudio.Editors
{
    ...
    public sealed class GeneratorError
    {
        ...
        GeneratorError( string message, int? line, int? column )
        {
        ...
        public GeneratorError( string message ) : this( message, null, null ) { }
        ...
        public GeneratorError( string message, int line ) : this( message, new int?( line ), null ) { }
        ...
        public GeneratorError( string message, int line, int column ) : this( message, new int?( line ), new int?( column ) )
        {
