namespace More.VisualStudio.Views
{
    ...
    {
        readonly IVsUIShell shell;
        readonly ProjectInformation projectInfo;
        readonly Lazy<IVsDataConnectionDialogFactory> dataConnectionDialogFactory;
        readonly Lazy<IVsDataExplorerConnectionManager> dataExplorerConnectionManager;

        /// <summary>
        /// Initializes a new instance of the <see cref="DbContextItemTemplateWizard"/> class.
        /// </summary>
        public DbContextItemTemplateWizard() => InitializeComponent();
        ...
        void WireInteractionRequests( DbContextItemTemplateWizardViewModel model )
        {
            if ( model == null )
            {
                return;
        ...
        void UnwireInteractionRequests( DbContextItemTemplateWizardViewModel model )
        {
            if ( model == null )
            {
                return;
        ...
        async void OnBrowseForModel( object sender, InteractionRequestedEventArgs e )
        {
        ...
        void OnAddDataConnection( object sender, InteractionRequestedEventArgs e )
        {
