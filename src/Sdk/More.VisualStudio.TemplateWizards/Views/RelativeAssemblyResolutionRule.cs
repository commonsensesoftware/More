namespace More.VisualStudio.Views
{
    ...
    sealed class RelativeAssemblyResolutionRule : IRule<ResolveEventArgs, Assembly>
    {
        ...
        public Assembly Evaluate( ResolveEventArgs item )
        {
            ...
            // the file doesn't exist or we can't build the name because the assembly name is not the same as the file name
