namespace More.VisualStudio.ViewModels
{
    ...
    public class ViewModelItemTemplateWizardViewModel : ObservableObject
    {
        ...
        readonly ObservableCollection<TemplateOption> baseClasses = new ObservableCollection<TemplateOption>();
        ...
        string title;
        int currentStep;
        TemplateOption selectedBaseClass;
        ...
        void OnOptionsChanged( object sender, NotifyCollectionChangedEventArgs e )
        {
            if ( CurrentStep != 0 )
            {
                return;
