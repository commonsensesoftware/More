namespace More.VisualStudio.ViewModels
{
    ...
    public class ViewItemTemplateWizardViewModel : ValidatableObject
    {
        ...
        readonly InteractionRequest<Interaction> browse = new InteractionRequest<Interaction>( "BrowseForViewModel" );
        ...
        readonly ObservableCollection<TemplateOption> viewOptions = new ObservableCollection<TemplateOption>();
        readonly ObservableCollection<TemplateOption> interactions = new ObservableCollection<TemplateOption>();
        readonly ObservableCollection<TemplateOption> appContracts = new ObservableCollection<TemplateOption>();
        int currentStep;
        bool topLevel;
        bool topLevelSupported;
        bool showTips = true;
        int interfaceOption;
        int viewModelOption = 1;
        string title = SR.ViewItemTemplateWizardTitle;
        ...
        public bool RequiresViewModel => ViewInterfaceOption > 0;
        ...
        public int ViewInterfaceOption
        {
            ...
            set
            {
                ...
                OnPropertyChanged( nameof( RequiresViewModel ) );
            }
        }
        ...
        {
            get => topLevel;
            set => SetProperty( ref topLevel, value );
        }
        ...
        {
            get => topLevelSupported;
            set => SetProperty( ref topLevelSupported, value );
        }
                ...
                case 1:
                    {
                        ...
                        {
                            return new ValidationResult( SR.ViewModelNameUnspecified, new[] { nameof( ViewModelName ) } );
                        }
                        ...
                        {
                            return new ValidationResult( SR.ViewModelNameNonUnique.FormatDefault( value ), new[] { nameof( ViewModelName ) } );
                        }
                ...
                case 2:
                    {
                        ...
                        if ( string.IsNullOrEmpty( value ) )
                        {
                            return new ValidationResult( SR.ExistingViewModelUnspecified, new[] { nameof( ViewModelName ) } );
                        }
                ...
                case 1: // view model options
                    {
                        switch ( ViewModelOption )
                        {
                            ...
                            case 1:
                                ...
                                return IsPropertyValid( ViewModelName, nameof( ViewModelName ) );
                            case 2:
                                // must have a selected view model
        ...
        bool OnCanBrowseForViewModel( object parameter ) => CurrentStep == 1 && ViewModelOption == 2;

        void OnBrowseForViewModel( object parameter )
        {
