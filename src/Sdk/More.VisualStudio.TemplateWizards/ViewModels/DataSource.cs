namespace More.VisualStudio.ViewModels
{
    ...
    public sealed class DataSource
    {
        ...
        Lazy<IVsDataConnection> dataConnection;

        internal DataSource( string displayName, IVsDataConnection dataConnection ) : this( displayName, new Lazy<IVsDataConnection>( () => dataConnection ) ) { }
