namespace More.ComponentModel.DataAnnotations
{
    ...
    {
        private readonly ObservableKeyedCollection<string, IPropertyValidator<T>> validators = new ObservableKeyedCollection<string, IPropertyValidator<T>>( v => v.PropertyName );
