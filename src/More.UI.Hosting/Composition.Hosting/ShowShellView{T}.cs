namespace More.Composition.Hosting
{
    ...
    public partial class ShowShellView<T> : Activity where T : class, IShellView
    {
        ...
        protected ShowShellView( string shellViewTypeName ) => ShellViewTypeName = shellViewTypeName;
        ...
        Type GetShellViewType( IServiceProvider serviceProvider )
        {
            Contract.Requires( serviceProvider != null );
            Contract.Ensures( Contract.Result<Type>() != null );

            var candidateType = ShellViewTypeName;
            var shellViewType = default( Type );
        ...
        void Show( IServiceProvider serviceProvider, Type shellViewType )
        {
            Contract.Requires( serviceProvider != null );
            Contract.Requires( shellViewType != null );

            var shell = default( IShellView );
