namespace More.Composition.Hosting
{
    ...
    {
        readonly List<Tuple<string, string, string>> appSettings = new List<Tuple<string, string, string>>();
        readonly Lazy<SearchContractOptions> searchOptions = new Lazy<SearchContractOptions>( () => new SearchContractOptions(), true );
        ...
        void ConfigureOrCreateSettingsContract( BehaviorCollection behaviors )
        {
        ...
        void ConfigureOrCreateSearchContract( BehaviorCollection behaviors )
        {
            Contract.Requires( behaviors != null );
