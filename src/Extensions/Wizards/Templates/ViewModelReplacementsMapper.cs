    ...
    internal sealed class ViewModelReplacementsMapper : ReplacementsMapper<ViewModelItemTemplateWizardViewModel>
    {
        ...
        protected override IReadOnlyList<Tuple<string, Func<ViewModelItemTemplateWizardViewModel, string>>> CreateWriters()
        {
            return new[]
            {
                ...
                new Tuple<string, Func<ViewModelItemTemplateWizardViewModel, string>>( "$showTextInputTips$", m => GetOptionTips( m.ShowTips, m.InteractionOptions, "TextInput" ) ),
                new Tuple<string, Func<ViewModelItemTemplateWizardViewModel, string>>( "$showSelectContactTips$", m => GetOptionTips( m.ShowTips, m.InteractionOptions, "SelectContact" ) ),
                ...
                new Tuple<string, Func<ViewModelItemTemplateWizardViewModel, string>>( "$enableTextInput$", m => GetOption( m.InteractionOptions, "TextInput" ) ),
                new Tuple<string, Func<ViewModelItemTemplateWizardViewModel, string>>( "$enableSelectContact$", m => GetOption( m.InteractionOptions, "SelectContact" ) ),
