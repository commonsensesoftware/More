...
{$if$($hasviewmodel$ == true)
    ...
    /// </summary>
    public partial class $safeitemrootname$ : Page$if$ ($hasviewmodel$ == true), INotifyPropertyChanged$endif$$if$ ($interfaceoption$ == 1), IView<$viewmodel$>$endif$$if$ ($interfaceoption$ == 2), IView<$viewmodel$,$viewmodel$>$endif$
    {
        /// <summary>
