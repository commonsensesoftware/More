namespace More.Composition.Hosting
{
    ...
    {
        private static void ConfigureWebApi( Host host, HttpConfiguration configuration, Action<HttpConfiguration> configurationCallback, WebApiConventions conventions )
        {
