namespace More.Composition.Hosting
{
    ...
    internal sealed class SettingsFlyoutSpecification : SpecificationBase<Type>
    {
        private static readonly TypeInfo settingsFlyout = typeof( SettingsFlyout ).GetTypeInfo();
