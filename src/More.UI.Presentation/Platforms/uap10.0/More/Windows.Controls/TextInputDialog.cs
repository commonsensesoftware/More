namespace More.Windows.Controls
{
    ...
    public partial class TextInputDialog
    {
        ...
        {
            get => (int) GetValue( DefaultCommandIndexProperty );
            set => SetValue( DefaultCommandIndexProperty, value );
        }
        ...
        {
            get => (int) GetValue( CancelCommandIndexProperty );
            set => SetValue( CancelCommandIndexProperty, value );
        }
