namespace More.Windows.Controls
{
    ...
    public abstract class InputDialog<T> : ContentControl where T : class
    {
        ...
        /// </summary>
        protected InputDialog() => commands = new CommandCollection( this );
        ...
        public virtual T Response { get; protected internal set; }

        /// <summary>
        /// Gets or sets the input dialog default response.
        /// </summary>
        /// <value>The input dialog default response.</value>
        public virtual T DefaultResponse { get; set; }
        ...
        Task<T> ShowDialog( CancellationToken token )
        {
        ...
        {
            readonly InputDialog<T> dialog;

            internal CommandCollection( InputDialog<T> dialog ) => this.dialog = dialog;
