namespace More.Windows.Interactivity
{
    ...
    public class PopupAction : System.Windows.Interactivity.TriggerAction
    {
        ...
        /// <summary>
        /// Gets the dependency property for the popup view <see cref="Style">style</see>.
        /// </summary>
        /// <value>A <see cref="DependencyProperty"/> object.</value>
        [SuppressMessage( "Microsoft.Security", "CA2104:DoNotDeclareReadOnlyMutableReferenceTypes", Justification = "Dependency properties are immutable." )]
        ...
        /// </summary>
        /// <returns>A new object or null if <see cref="ViewType"/> is null.</returns>
        /// <remarks>If the view specified by the <see cref="ViewType">window type</see> is a composed view,
        /// the default implementation will be to use the <see cref="ServiceProvider.Current">current service provider</see>
        /// to compose it.  If the view is not composed, then the fallback method will be <see cref="Activator.CreateInstance(Type)"/>.</remarks>
