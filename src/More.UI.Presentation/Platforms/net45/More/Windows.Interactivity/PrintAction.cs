namespace More.Windows.Interactivity
{
    ...
    public class PrintAction : System.Windows.Interactivity.TriggerAction<FrameworkElement>
    {
        ...
        {
            get => (bool) GetValue( ShowPrintOptionsProperty );
            set => SetValue( ShowPrintOptionsProperty, value );
        }
        ...
        {
            get => (bool) GetValue( SupportsSearchProperty );
            set => SetValue( SupportsSearchProperty, value );
        }
        ...
        static void HideSearchBox( DocumentViewer viewer )
        {
            Contract.Requires( viewer != null );
