namespace More.Windows.Interactivity
{
    ...
    {
        readonly Dictionary<Type, Delegate> attachMethods = new Dictionary<Type, Delegate>();
        ...
        static Delegate CreateAttachDelegate( Window window, Interaction interaction )
        {
