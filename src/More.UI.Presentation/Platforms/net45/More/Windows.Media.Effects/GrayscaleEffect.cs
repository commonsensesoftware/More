namespace More.Windows.Media.Effects
{
    ...
    public class GrayscaleEffect : ShaderEffect
    {
        ...
        public static readonly DependencyProperty InputProperty =
            ShaderEffect.RegisterPixelShaderSamplerProperty( nameof( Input ), typeof( GrayscaleEffect ), 0 );

        static readonly PixelShader pixelShader = LoadShaderFromResource( "Windows.Media.Effects/GrayscaleEffect.ps" );
        ...
        static PixelShader LoadShaderFromResource( string resourceName )
        {
