namespace More.Windows.Controls.Automation.Peers
{
    ...
    public class MessageDialogAutomationPeer : DialogAutomationPeer<MessageDialog>
    {
        ...
        public MessageDialogAutomationPeer( MessageDialog owner ) : base( owner )
        {
            IsReadOnly = true;
            IsModal = true;
            IsTopmost = true;
        ...
        /// </summary>
        public override void Invoke() => Close();
        ...
        {
            get => Window.Content?.ToString();
            protected set => Window.Content = value;
        }
