namespace More.Windows.Controls.Automation.Peers
{
        ...
        where T : Window
    {
        ...
        public WindowInteractionState InteractionState { get; protected set; }
        ...
        public bool IsTopmost { get; protected set; }
        ...
        public bool Maximizable { get; protected set; }
        ...
        public bool Minimizable { get; protected set; }
        ...
        public virtual void SetVisualState( WindowVisualState state ) => VisualState = state;

        /// <summary>
        /// Gets or sets the visual state of window provider automation peer.
        /// </summary>
        /// <value>One of the <see cref="WindowVisualState"/> values.</value>
        public abstract WindowVisualState VisualState { get; protected set; }
        ...
        public virtual bool WaitForInputIdle( int milliseconds ) => true;
    }
}