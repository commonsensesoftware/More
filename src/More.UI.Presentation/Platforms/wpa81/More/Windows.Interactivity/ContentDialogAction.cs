namespace More.Windows.Interactivity
{
    ...
    public class ContentDialogAction : System.Windows.Interactivity.TriggerAction
    {
        ...
        public bool HasCustomButtons { get; set; }
        ...
        protected virtual ContentDialog CreateDialog()
        {
            ...
            var dialog = default( ContentDialog );
            ...
            else
            {
                ...
                if ( !services.TryGetService( ViewType, out var view, ViewName ) )
                {
                    // use fallback method
                    view = Activator.CreateInstance( ViewType );

                    // try to compose the view
                    if ( services.TryGetService( out ICompositionService composer ) )
                    {
                ...
                {
                    dialog = new ContentDialog() { Content = view };
                }
            }
        ...
        void PrepareDialog( ContentDialog dialog, Interaction interaction )
        {
        ...
        {
            readonly ContentDialog dialog;
            readonly INamedCommand primary;
            readonly INamedCommand secondary;
            ContentDialogButtonClickDeferral deferral;
            ...
            INamedCommand WirePrimaryCommand( INamedCommand command )
            {
            ...
            INamedCommand WireSecondaryCommand( INamedCommand command )
            {
            ...
            void OnPrimaryClick( object sender, ContentDialogButtonClickEventArgs e )
            {
            ...
            void OnPrimaryCanExecuteChanged( object sender, EventArgs e )
            {
                var parameter = dialog.PrimaryButtonCommandParameter;
            ...
            void OnSecondaryClick( object sender, ContentDialogButtonClickEventArgs e )
            {
                Contract.Requires( e != null );
            ...
            void OnSecondaryCanExecuteChanged( object sender, EventArgs e )
            {
