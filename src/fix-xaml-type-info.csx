...
{
    public XamlTypeInfoRewriter()
        : base( visitIntoStructuredTrivia: true )
    {
    }

    private static AttributeListSyntax NewClsCompliantAttribute()
    {
    ...
    private static AttributeListSyntax NewEditorBrowsableAttribute()
    {
    ...
    private static ClassDeclarationSyntax AddAttributeIfNecessary( ClassDeclarationSyntax @class, string attributeName, Func<AttributeListSyntax> newAttribute )
    {
    ...
    private static ClassDeclarationSyntax AddClsCompliantIfNecessary( ClassDeclarationSyntax @class ) =>
        AddAttributeIfNecessary( @class, typeof( CLSCompliantAttribute ).FullName, NewClsCompliantAttribute );

    private static ClassDeclarationSyntax AddEditorBrowsableIfNecessary( ClassDeclarationSyntax @class ) =>
