namespace More.Composition.Hosting
{
    ...
    /// <summary>
    /// Represents the default ASP.NET Web API hosting conventions.
    /// </summary>
    public class WebApiConventions
    {
        static readonly IRule<ImportParameter> DefaultImportParameterRule = new Rule<ImportParameter>( DefaultAction.None );
        IRule<ImportParameter> importParameterRule = DefaultImportParameterRule;
