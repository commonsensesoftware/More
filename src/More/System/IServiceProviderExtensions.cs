namespace System
{
    ...
    public static class IServiceProviderExtensions
    {
        ...
        static object GetServiceWithKey( IServiceProvider serviceProvider, Type serviceType, string key )
        {
        ...
        static IEnumerable<TService> GetServicesWithKey<TService>( IServiceProvider serviceProvider, Type serviceType, string key )
        {
            var generator = new ServiceTypeAssembler();
            var multipleServicesType = generator.ForMany( serviceType );
