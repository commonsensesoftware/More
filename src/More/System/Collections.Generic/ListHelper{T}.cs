namespace System.Collections.Generic
{
    ...
    {
        static bool IsTypeComparable => typeof( IComparable<T> ).GetTypeInfo().IsAssignableFrom( typeof( T ).GetTypeInfo() );

        static void SwapByComparable( IList<T> keys, int a, int b )
        {
        ...
        static void SwapByComparer( IList<T> keys, IComparer<T> comparer, int a, int b )
        {
            Contract.Requires( keys != null );
        ...
        static void QuickSortByComparable( IList<T> keys, int left, int right )
        {
            Contract.Requires( keys != null );
        ...
        static void QuickSortByComparer( IList<T> keys, int left, int right, IComparer<T> comparer )
        {
            Contract.Requires( keys != null );
            Contract.Requires( comparer != null );
            Contract.Requires( left >= 0 && left <= keys.Count );
        ...
        static int BinarySearchByComparer( IList<T> list, int index, int length, T value, IComparer<T> comparer )
        {
            Contract.Requires( list != null );
            Contract.Requires( comparer != null );
            Contract.Requires( index >= 0 && index < list.Count );
        ...
        internal static void Sort( IList<T> keys, int index, int length, IComparer<T> comparer )
        {
            ...
            {
                throw new ArgumentException( ExceptionMessage.BogusIComparer.FormatDefault( default( T ), typeof( T ).Name ), comparer.GetType().Name ?? "(null)" );
            }
            catch ( Exception exception )
            {
                throw new InvalidOperationException( ExceptionMessage.IComparerFailed, exception );
