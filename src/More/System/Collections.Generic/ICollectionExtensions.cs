namespace System.Collections.Generic
{
    ...
    {
        static ICollection<TItem> AddRange<TItem>( this ICollection<TItem> collection, IEnumerable<TItem> sequence, int? count, bool clearFirst )
        {
        ...
        public static ICollection<TItem> AddRange<TItem>( this ICollection<TItem> collection, IEnumerable<TItem> sequence )
        {
            ...
            Contract.Ensures( Contract.Result<ICollection<TItem>>() != null );
            return collection.AddRange( sequence, count: null, clearFirst: false );
        }
