namespace System
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static DateTime DayOfWeekInMonth( this DateTime date, int occurrence, DayOfWeek dayOfWeek, Calendar calendar )
        {
            ...
            for ( var i = 0; i < occurrence; i++, day = day.AddDays( 1d ) )
            {
        ...
        public static DateTime StartOfYear( this DateTime date, Calendar calendar )
        {
            ...
            return date.AddDays( -calendar.GetDayOfYear( date ) + 1 );
        }
        ...
        public static int Week( this DateTime date, Calendar calendar, DayOfWeek firstDayOfWeek )
        {
            ...
            var rule = CurrentCulture.DateTimeFormat.CalendarWeekRule;
        ...
        public static int Semester( this DateTime date, Calendar calendar )
        {
            ...
            var month = (double) calendar.GetMonth( date );
            return (int) Math.Ceiling( month / 6d );
        }
        ...
        public static DateTime FirstDayOfWeekInMonth( this DateTime date, DayOfWeek dayOfWeek )
        {
            ...
            return date.FirstDayOfWeekInMonth( dayOfWeek, CurrentCulture.Calendar );
        }
        ...
        public static DateTime LastDayOfWeekInMonth( this DateTime date, DayOfWeek dayOfWeek )
        {
            ...
            return date.LastDayOfWeekInMonth( dayOfWeek, CurrentCulture.Calendar );
        }
        ...
        public static DateTime DayOfWeekInMonth( this DateTime date, int occurrence, DayOfWeek dayOfWeek )
        {
            ...
            return date.DayOfWeekInMonth( occurrence, dayOfWeek, CurrentCulture.Calendar );
        }
        ...
        {
            Contract.Ensures( Contract.Result<DateTime>().Week( CurrentCulture.Calendar, firstDayOfWeek ) == Contract.OldValue( date.Week( CurrentCulture.Calendar, firstDayOfWeek ) ) );
        ...
        {
            Contract.Ensures( CurrentCulture.Calendar.GetYear( Contract.Result<DateTime>() ) == Contract.OldValue( CurrentCulture.Calendar.GetYear( date ) ) );
            Contract.Ensures( CurrentCulture.Calendar.GetMonth( Contract.Result<DateTime>() ) == Contract.OldValue( CurrentCulture.Calendar.GetMonth( date ) ) );

            return date.StartOfMonth( CurrentCulture.Calendar );
        }
        ...
        {
            Contract.Ensures( CurrentCulture.Calendar.GetYear( Contract.Result<DateTime>() ) == Contract.OldValue( CurrentCulture.Calendar.GetYear( date ) ) );
            Contract.Ensures( Contract.Result<DateTime>().Quarter( CurrentCulture.Calendar ) == Contract.OldValue( date.Quarter( CurrentCulture.Calendar ) ) );

            return date.StartOfQuarter( CurrentCulture.Calendar );
        }
        ...
        {
            Contract.Ensures( CurrentCulture.Calendar.GetYear( Contract.Result<DateTime>() ) == Contract.OldValue( CurrentCulture.Calendar.GetYear( date ) ) );
            Contract.Ensures( Contract.Result<DateTime>().Semester( CurrentCulture.Calendar ) == Contract.OldValue( date.Semester( CurrentCulture.Calendar ) ) );

            return date.StartOfSemester( CurrentCulture.Calendar );
        }
        ...
        public static DateTime StartOfYear( this DateTime date )
        {
            ...
            return date.StartOfYear( CurrentCulture.Calendar );
        }
        ...
        public static DateTime EndOfDay( this DateTime date )
        {
            ...
            return date.Date.AddDays( 1d ).AddTicks( -1L );
        }
        ...
        {
            Contract.Ensures( Contract.Result<DateTime>().Week() == Contract.OldValue( date.Week() ) );
            return date.EndOfWeek( CurrentCulture.DateTimeFormat.FirstDayOfWeek );
        }
        ...
        {
            Contract.Ensures( Contract.Result<DateTime>().Week( CurrentCulture.Calendar, firstDayOfWeek ) == Contract.OldValue( date.Week( CurrentCulture.Calendar, firstDayOfWeek ) ) );
            return date.StartOfWeek( firstDayOfWeek ).AddDays( 7d ).AddTicks( -1L );
        }
        ...
        public static DateTime EndOfMonth( this DateTime date )
        {
            ...
            return date.EndOfMonth( CurrentCulture.Calendar );
        }
        ...
        public static DateTime EndOfQuarter( this DateTime date )
        {
            ...
            return date.EndOfQuarter( CurrentCulture.Calendar );
        }
        ...
        public static DateTime EndOfSemester( this DateTime date )
        {
            ...
            return date.EndOfSemester( CurrentCulture.Calendar );
        }
        ...
        public static DateTime EndOfYear( this DateTime date )
        {
            ...
            return date.EndOfYear( CurrentCulture.Calendar );
        }
        ...
        public static int Week( this DateTime date )
        {
            ...
            var format = CurrentCulture.DateTimeFormat;
        ...
        public static int Quarter( this DateTime date )
        {
            ...
            return date.Quarter( CurrentCulture.Calendar );
        }
        ...
        public static int Semester( this DateTime date )
        {
            ...
            return date.Semester( CurrentCulture.Calendar );
        }
        ...
        public static int Year( this DateTime date )
        {
            ...
            return date.Year( CurrentCulture.Calendar );
        }
    }
}