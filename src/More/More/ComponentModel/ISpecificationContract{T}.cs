namespace More.ComponentModel
{
    ...
    abstract class ISpecificationContract<T> : ISpecification<T>
    {
        bool ISpecification<T>.IsSatisfiedBy( T item ) => default( bool );
        ...
        bool IRule<T, bool>.Evaluate( T item ) => default( bool );
    }
}