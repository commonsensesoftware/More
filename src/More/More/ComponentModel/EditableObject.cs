namespace More.ComponentModel
{
    ...
    {
        readonly ISet<string> uneditableMembers;
        readonly Lazy<IEditTransaction> transaction;
        IEditSavepoint savepoint;
        EditRecoveryModel recoveryModel;
        bool editing;
        bool changed;
        bool changedState;
        ...
        protected EditableObject( params string[] uneditableMembers ) : this( (IEnumerable<string>) uneditableMembers ) { }
        ...
        /// <param name="validator">The associated <see cref="IValidator">validator</see>.</param>
        /// <param name="uneditableMembers">A <see cref="IEnumerable{T}">sequence</see> of uneditable member names.</param>
        protected EditableObject( IValidator validator, IEnumerable<string> uneditableMembers ) : base( validator )
        {
            Arg.NotNull( uneditableMembers, nameof( uneditableMembers ) );
        ...
        IEditTransaction Transaction => transaction.Value;
        ...
        bool UseFullRecovery => RecoveryModel == Full;
        ...
        {
            get => changed;
            protected set => SetProperty( ref changed, value );
        }
