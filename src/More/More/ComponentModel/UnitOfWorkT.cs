namespace More.ComponentModel
{
    ...
    public abstract class UnitOfWork<T> : ObservableObject, IUnitOfWork<T> where T : class
    {
        ...
        readonly HashSet<T> inserted;
        readonly HashSet<T> updated;
        readonly HashSet<T> deleted;

        /// <summary>
        /// Initializes a new instance of the <see cref="UnitOfWork{T}"/> class.
        /// </summary>
        protected UnitOfWork() : this( EqualityComparer<T>.Default ) { }
        ...
        public virtual bool HasPendingChanges => InsertedItems.Any() || UpdatedItems.Any() || DeletedItems.Any();
        ...
        /// </summary>
        public virtual void Rollback() => AcceptChanges();
