namespace More.ComponentModel
{
    ...
    {
        readonly IList<IRule<TInput, TOutput>> rules;

        /// <summary>
        /// Initializes a new instance of the <see cref="CompositeRule{TInput, TOutput}"/> class.
        /// </summary>
        protected CompositeRule() : this( new List<IRule<TInput, TOutput>>() ) { }
        ...
        protected virtual void InsertItem( int index, IRule<TInput, TOutput> item )
        {
            ...
            Arg.LessThanOrEqualTo( index, Count, nameof( index ) );
            rules.Add( item );
        }
        ...
        public void Add( IRule<TInput, TOutput> item ) => InsertItem( rules.Count, item );
        ...
        public bool Contains( IRule<TInput, TOutput> item ) => rules.Contains( item );
        ...
        public void CopyTo( IRule<TInput, TOutput>[] array, int arrayIndex ) => rules.CopyTo( array, arrayIndex );
        ...
        bool ICollection<IRule<TInput, TOutput>>.IsReadOnly => rules.IsReadOnly;
        ...
        public virtual IEnumerator<IRule<TInput, TOutput>> GetEnumerator() => rules.GetEnumerator();
