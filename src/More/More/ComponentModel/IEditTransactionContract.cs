namespace More.ComponentModel
{
    ...
    abstract class IEditTransactionContract : IEditTransaction
    {
        ...
        void IEditTransaction.Rollback( IEditSavepoint savepoint )
        {
            ...
            Contract.Requires<ArgumentNullException>( savepoint != null, nameof( savepoint ) );
            Contract.Requires<ArgumentException>( Equals( savepoint.Transaction ), nameof( savepoint ) );
        }
    }
}