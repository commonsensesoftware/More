namespace More
{
    ...
    public class DateTimeFormatProvider : IFormatProvider, ICustomFormatter
    {
        ...
        sealed class DateTimeFormatToken
        {
            ...
            internal DateTimeFormatToken( string format, bool literal ) : this( format, literal, false ) { }
        ...
        /// </summary>
        static class DateTimeFormatTokenizer
        {
            ...
            static void EnsureCurrentLiteralSequenceTerminated( IList<DateTimeFormatToken> tokens, StringBuilder token )
            {
        ...
        readonly DateTimeFormatInfo dateTimeFormat;
        readonly Calendar calendar;

        /// <summary>
        /// Initializes a new instance of the <see cref="DateTimeFormatProvider"/> class.
        /// </summary>
        public DateTimeFormatProvider() : this( CurrentInfo, CurrentInfo.Calendar ) { }
        ...
        public DateTimeFormatProvider( DateTimeFormatInfo dateTimeFormat ) : this( dateTimeFormat, dateTimeFormat?.Calendar ) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="DateTimeFormatProvider"/> class.
        /// </summary>
        /// <param name="calendar">The <see cref="Calendar"/> used by the format provider.</param>
        public DateTimeFormatProvider( Calendar calendar ) : this( CurrentInfo, calendar )
        {
        ...
        string GetCustomFormat( DateTime value, string format, IFormatProvider formatProvider )
        {
            Contract.Requires( !string.IsNullOrEmpty( format ) );
        ...
        static int ToDateTimeMonth( Calendar calendar, DateTime value )
        {
        ...
        public virtual string Format( string format, object arg, IFormatProvider formatProvider )
        {
            ...
            formatProvider = formatProvider == null || ReferenceEquals( this, formatProvider ) ? CurrentCulture : formatProvider;
