namespace More.Collections.Generic
{
    ...
    {
        readonly KeyedCollection<TKey, TItem> items;
        ...
        /// <returns>A <typeparamref name="TItem"/> object.</returns>
        public TItem this[TKey key] => Items[key];

        static bool IsCompatibleObject( object item ) => ( item is TItem ) || ( default( TItem ) != null && item == null );
        ...
        void IList<TItem>.Insert( int index, TItem item ) => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );

        [SuppressMessage( "Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Justification = "The collection is read-only." )]
        void IList<TItem>.RemoveAt( int index ) => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );

        [SuppressMessage( "Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Justification = "The collection is read-only." )]
        TItem IList<TItem>.this[int index]
        {
            get => this[index];
            set => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );
        }

        [SuppressMessage( "Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Justification = "The collection is read-only." )]
        void ICollection<TItem>.Add( TItem item ) => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );

        [SuppressMessage( "Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Justification = "The collection is read-only." )]
        void ICollection<TItem>.Clear() => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );
        ...
        int IList.Add( object value ) => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );

        [SuppressMessage( "Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Justification = "This is for legacy support." )]
        void IList.Clear() => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );
        ...
        [SuppressMessage( "Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Justification = "This is for legacy support." )]
        void IList.Insert( int index, object value ) => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );
        ...
        [SuppressMessage( "Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Justification = "This is for legacy support." )]
        void IList.Remove( object value ) => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );

        [SuppressMessage( "Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Justification = "This is for legacy support." )]
        void IList.RemoveAt( int index ) => throw new NotSupportedException( ExceptionMessage.CollectionReadOnly );
